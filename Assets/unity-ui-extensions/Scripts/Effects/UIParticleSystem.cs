        ...
        protected override void OnPopulateMesh(VertexHelper vh)
        {
            ...
            for (int i = 0; i < count; ++i)
            {
                ...
                if (textureSheetAnimation.enabled)
                {
                    ...
                    int x = frame % textureSheetAnimation.numTilesX;
                    int y = Mathf.FloorToInt(frame / textureSheetAnimation.numTilesX);

                    particleUV.x = x * particleWidth;
                    particleUV.y = (1f - particleHight) - y * particleHight;

                    particleUV.z = particleUV.x + particleWidth;
                    particleUV.w = particleUV.y + particleHight;
                }
